...
def exp_function_longflow_test(  # pylint: disable=W0102
        nspine=0,
        nleaf=1,
        nhost=20,
        SL_Gbps=100,
    ...
    test_name = f'exp_function_longflow_test_{mmu_kind}-{sche}-{cc}-{burst_hosts}h-{mx_pg+1}pg'
    ...
    for pg in [8]:
        ...
        for mmu in ['QASH', 'Normal']:
            ...
            for k in ks:
                ...
                test_name = exp_function_longflow_test(
                    mx_pg=7,
                    mmu_kind=mmu,
                    port_hdrm_k=k,
