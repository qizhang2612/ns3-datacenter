...
import numpy as np
filename1 = 'data/exp_function_burstflow_test_QASH-DWRR-None-16h-8pg/ilen.txt'
filename2 = 'data/exp_function_burstflow_test_Normal-DWRR-None-16h-8pg/ilen.txt'
...
# 将图形保存为PDF文件  
plt.savefig('function_burstflow_iqlen.png', format='png')  
