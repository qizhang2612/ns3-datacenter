...
for kind in ['back']:
    for mmu_kind in ['DCQCN','PowerTCP']: 
        ...
        # 将图形保存为PDF文件  f
        #plt.savefig(f'motivation_search_1cos_rate_{mmu_kind}_{back_load}_20ms.png', format='png')  
        plt.savefig(f'image/motivation_search_upstream_rate_{mmu_kind}_20ms.png', format='png')
        #plt.savefig(f'image/motivation_search_onlyback_upstream_rate_{mmu_kind}_20ms.png', format='png')
