    ...
    for kind in ['back']:
        ...
        for cc_kind in ['DCQCN', 'PowerTCP']: 
            ...
            for burst_load in burst_loads:
                ...
                filename1 = f'data/exp_benchmark_isolation-{load_kind}-xpod_DSH-DWRR-{cc_kind}-{back_load}back-{burst_load}burst-64KB-8pg/fct.txt'
                filename2 = f'data/exp_benchmark_isolation-{load_kind}-xpod_Normal-DWRR-{cc_kind}-{back_load}back-{burst_load}burst-64KB-8pg/fct.txt'
                filename3 = f'data/exp_benchmark_isolation-{load_kind}-xpod_DSHnoSH-DWRR-{cc_kind}-{back_load}back-{burst_load}burst-64KB-8pg/fct.txt'
                print(filename1)
                back_values = []
                burst_values = []
                back2_values = []
