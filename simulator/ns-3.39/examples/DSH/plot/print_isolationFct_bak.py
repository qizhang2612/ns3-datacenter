...
# this script is corresponding to "exp_isolation_InsRoom_bak.py"
...
for folder_name in folder_names:
    ...
    if match:
        ...
        if (mode == 'DSH' and cc == 'DCQCN'):
            folder_path = os.path.join(data_directory, folder_name)
            if os.path.isdir(folder_path):
                # open and get fct.txt
...
save_to_csv(x_DSH_DCQCN, y_DSH_DCQCN, y_DSHno_DCQCN, y_Normal_DCQCN, 'bak_DCQCN_DSH_DSHnoSH_SIH.csv')
save_to_csv(x_DSH_HPCC, y_DSH_HPCC, y_DSHno_HPCC, y_Normal_HPCC, 'bak_HPCC_DSH_DSHnoSH_SIH.csv')
save_to_csv(x_DSH_PowerTCP, y_DSH_PowerTCP, y_DSHno_PowerTCP, y_Normal_PowerTCP, 'bak_PowerTCP_DSH_DSHnoSH_SIH.csv')
save_to_csv(x_DSH_None, y_DSH_None, y_DSHno_None, y_Normal_None, 'bak_None_DSH_DSHnoSH_SIH.csv')

save_to_custom_csv(x_DSH_DCQCN, y_DSH_DCQCN, y_DSHno_DCQCN, y_Normal_DCQCN, 'bak_DCQCN_DSH_DSHnoSH_SIH.csv')
save_to_custom_csv(x_DSH_HPCC, y_DSH_HPCC, y_DSHno_HPCC, y_Normal_HPCC, 'bak_HPCC_DSH_DSHnoSH_SIH.csv')
save_to_custom_csv(x_DSH_PowerTCP, y_DSH_PowerTCP, y_DSHno_PowerTCP, y_Normal_PowerTCP, 'bak_PowerTCP_DSH_DSHnoSH_SIH.csv')
save_to_custom_csv(x_DSH_None, y_DSH_None, y_DSHno_None, y_Normal_None, 'bak_None_DSH_DSHnoSH_SIH.csv')
